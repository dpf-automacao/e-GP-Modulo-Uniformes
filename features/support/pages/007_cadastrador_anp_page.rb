class CadastradorAnpPage < SitePrism::Page
    ...
    element :medida_professor_img, "img[src='/sigrh/proforme/img/empty.gif']"
    ...
    def consultar_professor
        preencher_nome_professor
        preencher_cpf_professor
        buscar_professor
    end

    def preencher_nome_professor
        nome_professor_input.click.set("TESTE JUNIOR")
    end

    def preencher_cpf_professor
        cpf_professor_input.click.set("")
    end
    ...
    def cadastrar_medidas
        ...
        cadastrar_medidas_bone
        salvar_item
        concluir_item
        voltar_item

        cadastrar_medidas_bota
        salvar_item
        concluir_item
        voltar_item

        cadastrar_camiseta_op
        salvar_item
        concluir_item
        voltar_item
